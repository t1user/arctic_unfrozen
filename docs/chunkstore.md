...
At this point you have an empty Chunkstore library. You can write data to it several ways. The most basic is to use the `write` method. [Write](https://github.com/t1user/arctic_unfrozen/blob/master/arctic/chunkstore/chunkstore.py#L230) takes the following arguments:
