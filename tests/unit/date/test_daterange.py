...
test_ranges_for_bounding = {
    ...
    "open_open": (
        DateRange("20110101", "20111231", OPEN_OPEN),
        dt(2011, 1, 1),
        dt(2011, 12, 31),
        False,
        False,
...
test_ranges_for_bounding = sorted(
    test_ranges_for_bounding.items(), key=operator.itemgetter(1)
)
...
def test_intersection_preserves_boundaries():
    ...
    assert DateRange("20110101", "20110102", OPEN_OPEN) == DateRange(
        "20110101", "20110103", OPEN_CLOSED
    ).intersection(DateRange("20110101", "20110102", OPEN_OPEN))
    assert DateRange("20110101", "20110102", OPEN_OPEN) == DateRange(
        "20110101", "20110102", OPEN_OPEN
    ).intersection(DateRange("20110101", "20110103", OPEN_CLOSED))
    assert DateRange("20110102", "20110103", OPEN_OPEN) == DateRange(
        "20110102", "20110103", OPEN_OPEN
    ...
    # Matching boundaries
    assert DateRange("20110101", "20110102", OPEN_OPEN) == DateRange(
        "20110101", "20110102", CLOSED_OPEN
    ).intersection(DateRange("20110101", "20110102", OPEN_OPEN))
    assert DateRange("20110101", "20110102", OPEN_OPEN) == DateRange(
        "20110101", "20110102", OPEN_OPEN
    ).intersection(DateRange("20110101", "20110102", OPEN_CLOSED))
