...
def _mixed_test_data():
    ...
    if _TEST_DATA is None:
        ...
        with_some_objects_ts.iloc[0:NON_HOMOGENEOUS_DTYPE_PATCH_SIZE_ROWS, 1] = (
            "A string"
        )
        ...
        large_with_some_objects.iloc[0:NON_HOMOGENEOUS_DTYPE_PATCH_SIZE_ROWS, 1] = (
            "A string"
        )
        ...
        multi_column_with_some_objects.iloc[1:, 1:2] = (
