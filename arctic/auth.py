...
def get_auth(
    host: str, app_name: str, database_name: str | None
) -> MongoCredentials | None:
    """
...
def create_client(
    host: str, credentials: MongoCredentials | None = None, **kwargs: Any
    ...
    if credentials is not None:
        kwargs.update(
            ...
            authSource=credentials.database,
        )
