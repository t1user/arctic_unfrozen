...
class DateRange(GeneralSlice):
    ...
    def __init__(
        self,
        start: DateRangeInput = None,
        end: DateRangeInput = None,
    ...
    def intersection(self, other: "DateRange") -> "DateRange":
        ...
        new_start = (
            self.start
            if other.start is None
            else other.start if self.start is None else max(self.start, other.start)
        )
        new_end = (
            self.end
            if other.end is None
            else other.end if self.end is None else min(self.end, other.end)
        )
